// A realistic spread of bank and UPI alerts so the app is usable on first open,
// before the user imports their own. Spans two months across many banks,
// channels, and categories, with a couple of recurring subscriptions.
...
export const SAMPLE_ALERTS: string[] = [
  ...
  "123456 is your OTP for a txn of Rs.500 at Amazon. Do not share with anyone.",
  "Get 10% cashback on your next UPI payment with HDFC Bank. T&C apply.",
];
